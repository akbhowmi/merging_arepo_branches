 ...
 */
static int GasNeighbor_evaluate(int target, int mode, int threadid);
...
#pragma omp atomic capture
        ...
        if(GasNeighbor_isactive(i))
          GasNeighbor_evaluate(i, MODE_LOCAL_PARTICLES, threadid);
      }
  }
}
...
#pragma omp atomic capture
        ...
        GasNeighbor_evaluate(i, MODE_IMPORTED_PARTICLES, threadid);
      }
  }
}
