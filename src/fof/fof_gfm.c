              ...
              if(P[FOF_PList[start + lenloc].Pindex].ID == BPP(FOF_PList[start + lenloc].Pindex).ID_Min_BH_Potential)
                {
                  ...
                  BPP(FOF_PList[start + lenloc].Pindex).BH_RadioLum = (All.Hubble / All.cf_H) * blackhole_get_radio_efficiency(vvir) *
                                                                      BPP(FOF_PList[start + lenloc].Pindex).BH_XrayLum;

                  BPP(FOF_PList[start + lenloc].Pindex).BH_Mdot_radio =
                      blackhole_get_mdot_radio_from_radiolum(FOF_PList[start + lenloc].Pindex);
                }
#endif
