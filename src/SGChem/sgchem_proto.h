...
void EVOLVE_ABUNDANCES(double *time, double *dl, double *yn, double *divv, double *energy, double *redshift,
                       ...
                       double column_density_projection_co[NPIX], double column_density_projection_C[NPIX],
                       double photorates_direct[NDIRECT], double *dust_temp, double *sink_flux, int *id);
...
void INIT_CHEMISTRY_PARAMETERS(double *deuterium,
                               ...
                               double *tempFloor,
#endif
                               double *redshift, double *AV_ext, double *h2_form_ex, double *h2_form_kin, long *iphoto, long *isrf,
                               long *iflag_atom, long *iflag_H2_opacity);
void lwbg(void);
...
void CALC_GAMMA(double *abh2, double *ekn, double *gamma);
