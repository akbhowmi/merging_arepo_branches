...
#if defined(MRT) && !defined(SGCHEM)
#define SCALAR_TYPE_HYDROGEN 3
#define SCALAR_TYPE_HELIUM 4
#endif
...
#elif CHEMISTRYNETWORK == 15 || CHEMISTRYNETWORK == 16
#define SCALAR_TYPE_CARBON 8
#define SCALAR_TYPE_HELIUM 9
#define SCALAR_TYPE_METAL 10 /* Actually Silicon for network 16 */
...
#if defined(DEREFINE_GENTLY) && !defined(GRADIENTS_GREEN_GAUSS)
  int idx;
#endif
...
extern struct primexch
{
...
#ifdef SGS_TURBULENCE
  double SGS_T_SpecificEnergy;
  double SGS_T_Pressure;
#endif
  ...
  double ChimesAbundances[TOTSIZE];
  double XH;
#endif
...
struct state
{
  ...
  struct grad_data gradReconstruct;
#endif
