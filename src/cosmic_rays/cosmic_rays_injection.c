...
static void out2particle(data_out *out, int i, int mode) { CREnergy_Injected += out->EnergyInjected; }
          ...
          if(r2 < h2)
            {
              ...
              e_inj = All.CREnergyInputPerSolarMassOfStarFormation / All.UnitEnergy_in_cgs * mass * All.UnitMass_in_g / SOLAR_MASS *
                      weight_fac;
