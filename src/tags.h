...
#define TAG_PDATA_SINKS 123
#define TAG_SINKSDATA 124
#define TAG_KEY_SINKS 125

#ifdef CHIMES
#define TAG_CHIMESDATA 126
#define TAG_ABUNDATA 127

#ifdef CHIMES_PTHREADS
#define TAG_CHIMES_PTHREAD 128
#define TAG_PHOTDATA 129
#define TAG_TEMPDATA 130
#endif
#endif

#ifdef OUTPUT_LOG_FILES_FOR_SEEDING
#define TAG_FOF_DMMASS 131
#define TAG_FOF_TASK 132
#endif

#ifdef DEBUG
#define TAG_GAS_ID 133
#define TAG_GAS_DENSITY 134
#define TAG_GAS_METALLICITY 135
#define TAG_GAS_MASS 136
#endif

#ifdef CALCULATE_LYMAN_WERNER_INTENSITY_ALL_SOURCES
#define TAG_LYMAN_A 137
#endif

#ifdef CALCULATE_LYMAN_WERNER_INTENSITY_ALL_STARFORMINGGAS
#define TAG_LYMAN_B 138
#endif

#ifdef SEED_BASED_ON_PROBABLISTIC_HALO_PROPERTIES
#define TAG_BHSEED1 139
#define TAG_BHSEED2 140
#define TAG_BHSEED3 141
#define TAG_BHSEED4 142
#define TAG_BHSEED5 143
#define TAG_BHSEED6 144
#define TAG_BHSEED7 145
#endif

#ifdef SEED_HALO_ENVIRONMENT_CRITERION
#define TAG_ENVIRONMENT 146
#define TAG_N2 147
#define TAG_DENS_A2 148
#endif
