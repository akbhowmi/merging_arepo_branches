...
#endif
#ifdef TREECOLV2_C
                  SphP[i].ProjectionC[j] = out->ProjectionC[j];
#endif
                }
            }
#endif
...
#endif
#ifdef TREECOLV2_C
              Tree_ResultsActiveImported[idx].ProjectionC[j] = out->ProjectionC[j];
#endif
            }
#endif
...
#endif
#ifdef TREECOLV2_C
            SphP[target].ProjectionC[j] = tmp_results[i].ProjectionC[j];
#endif
          }
#endif
    }
