""" @package ./examples/fastwave_local_timestepping_2d/check.py
...
# Needed for fitting exponential decay
...
print("examples/fastwave_local_timestepping_2d/check.py: checking simulation output in directory "
