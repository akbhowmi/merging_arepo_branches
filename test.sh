...
TESTS+='brag_2d '
TESTS+='fastwave_2d '
TESTS+='fastwave_local_timestepping_2d '
TESTS+='fastwave_RKL2/fastwave_RKL2_timestepping_2d '
TESTS+='fastwave_subcycling_2d '
TESTS+='fastwave_RKL2/fastwave_RKL2_plus_local_timestepping_2d '
